...
Category / Type
  ...
  1   Corner Category
  100 Regular Type (T3)
  101 W/Outer Type (T4 = T3 + outer)
  110 w/Inner Type (T5 = T3 + corner dot) (I think T5(2) looks better)
  111 Squared Type (Ghost House) (T8 = T3 + center dot and corner dot)
  ToDo: Change order to: regular, inner, outer, ghosthouse.  That way 1s bit (tile&1 = 1 or 0) will draw corner dot or not
...
|█████| |██ ██| |█████| |██ ██| | █ ██| |██ █ | | ████| |█████| |██ █ | |█████| |██ ██|
------- ------- ------- ------- ------- ------- ------- ------- ------- ------- -------
   T0     T1      T2      T3      T4      T5      T6      T7      T8      T9     T5(2)
